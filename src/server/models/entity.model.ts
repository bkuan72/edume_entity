...
export class EntityModel {
   ...
   */
  create = (dataInEntity: any, session?: Session): Promise<any> => {
  ...
  updateById = async (
    ...
    return new Promise((resolve) => {
      SqlFormatter.formatUpdate(this.tableName, this.schema, entityDTO).then(
        (sql) => {
            ...
            .then((resp) => {
              appDbConnection
                ...
                .then(() => {
                  ...
                  this.findById(entityId, resp.DBSession).then((respEntityDTO) => {
   ...
   */
  getAll = (session?: Session): Promise<any[]> => {
    return new Promise((resolve) => {
      const respEntityDTOArray: any[] = [];
   ...
   * @param id entity.id
   */
  deleteById = (id: string, session?: Session): Promise<any[]> => {
    return new Promise((resolve) => {
          ...
          .then((result) => {
            if (result.rows.length) {
              result.rows.forEach((row) => {
                ...
                const respDTO = new this.responseDTO(data);
